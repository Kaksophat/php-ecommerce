...
if (isset($_POST['addcart'])) {
    ...
    $cart_sql = "SELECT * FROM cart WHERE product_id = '$product_id'";
     

    if ($cart_sql) {  
            $update_sql = "UPDATE cart SET product_qty = product_qty + '$product_qty' WHERE product_id = '$product_id'";
            $update_result = mysqli_query($conn, $update_sql);
           
        } 
  if(!$cart_sql){
        $insert_sql = "INSERT INTO cart(product_id,product_qty) VALUES ('$product_id', '$product_qty')";
                                ...
                                <div class='cart-concern position-absolute'>
                                    <div class='cart-button d-flex'>
                                        <form method='POST' action=''>
                                            ...
                                            <button type='submit' class='btn btn-medium btn-black' name='addcart'>Add to Cart<svg class='cart-outline'><use xlink:href='#cart-outline'></use></svg></button>
                                        </form>
                                    </div>
                                </div>
