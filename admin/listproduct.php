                            ...
                            <div class="card">
                                ...
                                if ($result && mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td style='width:80px'><img src='./upload/" . $row['image'] . "' alt='" . $row['product_name'] . "' width=70px hight=70px></td>";
                                        echo "<td><a href='editproduct.php?id=" . $row['id'] . "' class='btn btn-warning'>Edit</a> <a href='./include/delete.php?id=" . $row['id'] . "' class='btn btn-danger'>Delete</a></td>";
                                        echo "</tr>";
                                    }
                                } else {
