...
$result = mysqli_query($conn,$sql);
 ...
 if($result && mysqli_num_rows($result) > 0) {
  ...
  if(isset($_POST['submit'])){
    $categoryname = $_POST['cetegoryname'];
    $categoryslug = $_POST['cetegoryslug'];
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title text-center">Add Cetegory</h4>
                    </div>
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="productName">Cetegory Name</label>
                                <input type="text" class="form-control" id="productName" name="cetegoryname" required>
                            </div>
                            <div class="form-group">
                                <label for="">Cetegory Slug</label>
                                <input type="text" class="form-control" id="productPrice" name="cetegoryslug" required>
                            </div>
